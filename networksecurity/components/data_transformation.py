...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        "knn imputer"
        logging.info("entered get_tarnsformer_obnject method of transformation class")
        try:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("enter the inititate data transfomration of datatransformation class")
        try:
